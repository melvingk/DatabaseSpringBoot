package com.qa.mySpringDatabaseApp.controller;
...
import com.qa.mySpringDatabaseApp.exception.ResourceNotFoundException;
import com.qa.mySpringDatabaseApp.model.mySpringBootDataModel;
import com.qa.mySpringDatabaseApp.repository.personRepository;
...
public class mySpringBootDataAppController {
	...
	@PostMapping ("/person")
	public mySpringBootDataModel createsPerson (@Valid @RequestBody mySpringBootDataModel mSDM)
	{
